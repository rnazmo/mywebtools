...
- [x] `ADR.md` に序盤の技術選定に関する意思決定を書く
  ...
  - Tailwind CSS 採用の判断
  - shadcn/ui 採用の判断
- [ ] 序盤の意思決定に関して追加の ADR を書く：「ビルドツールの選定 → Vite を採用」
- [ ] 序盤の意思決定に関して追加の ADR を書く：「言語の選定 → TypeScript を採用」
- [ ] 序盤の意思決定に関して追加の ADR を書く：「ルーティングライブラリの選定 → React Router を採用」
- [ ] 序盤の意思決定に関して追加の ADR を書く：「Reactのバージョン → React 19 を採用」
  - これに関しては、意思決定をしたというよりも何も考えずにやったらそうなった、というかんじなので、書き方を要検討
- [ ] 序盤の意思決定に関して追加の ADR を書く：「コンポーネント設計方針 → ページ単位のシンプルなフラット構成を採用」
  - これに関しては、意思決定をしたというよりも何も考えずにやったらそうなった、というかんじなので、書き方を要検討
